...
namespace RHost
{
	public static class FdkTradeReports
	{
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.OrderCreated.SpecifyToUtc()).ToArray();
        }
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.OrderModified.SpecifyToUtc()).ToArray();
        }
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.PositionClosed.SpecifyToUtc()).ToArray();
        }
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.PositionModified.SpecifyToUtc()).ToArray();
        }
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.PositionOpened.SpecifyToUtc()).ToArray();
        }
        ...
        {
            var tradeData = FdkVars.GetValue<TradeTransactionReport[]>(varName);
            return tradeData.Select(it => it.TransactionTime.SpecifyToUtc()).ToArray();
        }
